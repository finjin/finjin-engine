...
def main(args = None):
    ...
    if sys.platform == 'win32':
        vulkan_include_directory = r'C:\VulkanSDK\1.0.46.0\Include\vulkan'
    else:
        vulkan_include_directory = r'/home/derek/Downloads/VulkanSDK/1.0.46.0/x86_64/include/vulkan'
