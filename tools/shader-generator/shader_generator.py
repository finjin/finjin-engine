...
class CompilerRun:
    def __init__(self, shader_compiler_path, shader_entry_point_prefix, shader_file_name_suffix, shader_output_file_extension, shader_model_and_version):
        ...
        self.combined_shader_start_alignment = 0
...
class D3D12CompilerRun(CompilerRun):
    ...
    def get_command_string(self, macros, shader_entry_point, shader_output_file_path, shader_input_file_path):
        ...
        return '"{0}" /enable_unbounded_descriptor_tables /nologo /T {1} {2} /E {3} /Fo "{4}" "{5}"'.format(self.shader_compiler_path, self.shader_model_and_version, macros_string, shader_entry_point, shader_output_file_path, shader_input_file_path)
...
def main(args = None):
    ...
    if shader_api == ShaderAPI.D3D12:
        ...
        compiler_path = 'C:/VulkanSDK/1.0.13.0/Bin32/glslangvalidator'
