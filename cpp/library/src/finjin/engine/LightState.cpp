...
int LightState::GetLightTypePriority() const
{
    return static_cast<int>(this->lightType);
}

MathVector4& LightState::GetWorldPosition(MathVector4& position4) const
{
...
MathVector3& LightState::GetWorldPosition(MathVector3& position3, MathVector4& position4) const
{
    static MathVector4 localPosition(0, 0, 0, 1);
    position4 = this->worldMatrix * localPosition;
...
MathVector3& LightState::GetWorldDirection(MathVector3& direction3, MathVector4& direction4) const
{
