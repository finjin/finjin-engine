...
namespace Finjin { namespace Engine {
    ...
    class AVAudioEngineSoundSource
    {
        ...
        friend class AVAudioEngineSoundBuffer;
        friend class AVAudioEngineSoundGroup;
        friend class AVAudioEngineSoundSourceLookup;

    public:
        AVAudioEngineSoundSource();
        ~AVAudioEngineSoundSource();
        ...
        AVAudioEngineSoundGroup* GetGroup();
        void SetGroup(AVAudioEngineSoundGroup* group);

        AVAudioEngineSoundBuffer* GetBuffer();
        bool SetBuffer(AVAudioEngineSoundBuffer* soundBuffer);
    ...
    private:
        AVAudioEngineSoundSourceImpl* impl;

    public:
        AVAudioEngineSoundSource* soundBufferNext; //Used to create a linked list of sound sources that share the same sound buffer
        AVAudioEngineSoundSource* soundGroupNext; //Used to create a linked list of sound sources that share the same sound group
    };
