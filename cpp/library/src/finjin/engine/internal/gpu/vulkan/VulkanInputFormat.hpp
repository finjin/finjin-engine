...
namespace Finjin { namespace Engine {
    ...
    public:
        ...
        //Note that this modifies the format, so this should be set any time the input format is used to create something
    ...
    public:
        ...
        DynamicVector<VkVertexInputAttributeDescription> attributes;
    };
